...
void init_metric()
{
	for(int i = 0; i < NDIM; i++)
		...
		{
			metricFunc[i][j] = [](double x1, double x2, double x3) {return 0.; };
			for(int k = 0; k < NDIM; k++)
				metricDiff[i][j][k] = [](double x1, double x2, double x3) {return 0.; };
		}
	...
	metricDiff[3][3][1] = [](double x1, double x2, double x3) {return (1 + h * pow(cos(x2), 2)) * pow(sin(x2), 2) * (2 * x1 + pow(a, 2) * ((-4 * pow(x1, 2)) / pow(pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2), 2) + 2 / (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2))) * pow(sin(x2), 2)); };
	metricDiff[3][3][2] = [](double x1, double x2, double x3) {return 2 * cos(x2) * (1 + h * pow(cos(x2), 2)) * sin(x2) * (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2) + pow(a, 2) * (1 + (2 * x1) / (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2))) * pow(sin(x2), 2)) - 2 * h * cos(x2) * pow(sin(x2), 3) * (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2) + pow(a, 2) * (1 + (2 * x1) / (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2))) * pow(sin(x2), 2)) + (1 + h * pow(cos(x2), 2)) * pow(sin(x2), 2) * (-2 * pow(a, 2) * cos(x2) * sin(x2) + 2 * pow(a, 2) * cos(x2) * (1 + (2 * x1) / (pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2))) * sin(x2) + (4 * pow(a, 4) * x1 * cos(x2) * pow(sin(x2), 3)) / pow(pow(x1, 2) + pow(a, 2) * pow(cos(x2), 2), 2)); };
}